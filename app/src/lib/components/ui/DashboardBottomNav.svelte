...
>
	<button
		type="button"
		class="flex flex-col items-center gap-1 min-w-[4rem] py-2.5 px-3 rounded-xl transition-all btn-glass-flat {active === 'home'
	...
	<button
		type="button"
		class="flex flex-col items-center gap-1 min-w-[4rem] py-2.5 px-3 rounded-xl transition-all btn-glass-flat {active === 'scan'
			? 'text-neutral-900 font-medium'
			: 'text-neutral-500'}"
		onclick={onScan}
	...
	<button
		type="button"
		class="flex flex-col items-center gap-1 min-w-[4rem] py-2.5 px-3 rounded-xl transition-all btn-glass-flat {active === 'account'
			? 'text-neutral-900 font-medium'
			: 'text-neutral-500'}"
