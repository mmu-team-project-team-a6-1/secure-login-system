...
<div class="min-h-screen flex items-center justify-center bg-[#B784C7] p-4 md:p-6">
	<div class="relative w-full max-w-6xl min-h-[70vh] overflow-x-clip">
		<div class="absolute inset-0 bg-white rounded-[36px] rotate-[-2deg]" aria-hidden="true"></div>
		<div
			class="relative w-full min-h-[70vh] bg-[#0B0B0D] rounded-[36px] overflow-hidden flex items-center justify-center px-6 py-10 lg:px-16"
		>
			<div class="flex flex-col lg:flex-row items-center gap-8 lg:gap-16 w-full justify-center">
				<LoginCard />
